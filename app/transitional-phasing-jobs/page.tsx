...
// ...existing code...
  return (
    <main style={{ minHeight: '100vh', background: '#f5f3fd', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 1rem' }}>
      <section style={{ width: '100%', maxWidth: 700, margin: '3rem auto 2rem auto', background: 'linear-gradient(90deg, #f5f3fd 0%, #e0d6f7 100%)', borderRadius: 24, boxShadow: '0 4px 32px #18191a22', padding: '2rem 0', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', fontFamily: 'Arial, Verdana, system-ui, sans-serif' }}>
      ...
      <div className="w-full max-w-3xl rounded-xl shadow-lg p-8 border mb-12" style={{ background: '#fff', borderColor: '#e0d6f7', fontFamily: 'Arial, Verdana, system-ui, sans-serif', color: '#18191a' }}>
        <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: '#18191a', fontFamily: 'Arial, Verdana, system-ui, sans-serif' }}>Jobs at Risk</h2>
      ...
      <div className="w-full max-w-3xl rounded-xl shadow-lg p-8 border mb-12" style={{ background: '#fff', borderColor: '#e0d6f7', fontFamily: 'Arial, Verdana, system-ui, sans-serif', color: '#18191a' }}>
        <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: '#18191a', fontFamily: 'Arial, Verdana, system-ui, sans-serif' }}>Jobs Replaced or Evolving with AI</h2>
