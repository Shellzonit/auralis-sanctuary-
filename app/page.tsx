...
export default function HomePage() {
	return (
		<main className="min-h-screen flex bg-gradient-to-br from-[#f7fafc] to-[#e9e4f0] text-[#222]">
			{/* Sidebar Navigation */}
			<aside className="w-64 min-h-screen flex flex-col items-start py-16 px-8 bg-white shadow-2xl rounded-r-3xl">
			...
			<section className="flex-1 flex flex-col justify-center items-center">
				...
				/>
				<h1 className="text-5xl font-extrabold text-[#4B2E83] mb-4 text-center">AI Wilding Portal</h1>
				<p className="text-xl text-[#444] text-center max-w-xl">
					Discover the future of work and AI. Use the navigation to explore resources, insights, and opportunities.
				</p>
			</section>
		</main>
	);
