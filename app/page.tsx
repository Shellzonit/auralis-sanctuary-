export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col justify-center items-center bg-[#F7F5F2] text-[#222] px-4">
      <div className="flex-1 flex flex-col justify-center items-center w-full">
        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-center" style={{ color: '#4B2E83' }}>
          Welcome to AI Wilding
        </h1>
        <p className="text-xl md:text-2xl mb-8 font-medium text-center" style={{ color: '#C2A86C' }}>
          Navigating the future of work and AI—resources, insights, and support for everyone.
        </p>
        <p className="text-lg md:text-xl text-[#444] whitespace-pre-line text-center">
