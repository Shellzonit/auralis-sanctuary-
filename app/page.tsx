...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen font-sans flex flex-col items-center px-2" style={{ backgroundColor: '#121110', color: '#FFFFFF' }}>
      {/* Tabs Bar */}
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <div className="font-sans text-xl text-center max-w-2xl mb-2" style={{ color: '#FFFFFF' }}>
      ...
      <section className="flex flex-col md:flex-row gap-10 justify-center items-center my-12 w-full">
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-4 border border-peach-100 max-w-md w-full">
          ...
          <span className="text-base font-medium" style={{ color: '#FFFFFF' }}>AI in the Workplace</span>
        </div>
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-4 border border-peach-100 max-w-md w-full">
          ...
          <span className="text-base font-medium" style={{ color: '#FFFFFF' }}>AI and Jobs</span>
        </div>
      </section>
    </main>
  );
