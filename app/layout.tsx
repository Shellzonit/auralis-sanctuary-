    ...
    <html lang="en">
      ...
      >
        <nav style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem 2rem 0.5rem 2rem" }}>
          ...
          <a href="/transitional-phasing-jobs" style={{ color: '#ffd700', fontWeight: 600, fontSize: 17, textDecoration: 'none', padding: '0.4rem 1.2rem', borderRadius: 10, background: '#23242b', border: '1.5px solid #ffd700', boxShadow: '0 2px 8px #0002', transition: 'background .18s', marginLeft: 16 }}>Transitional Phasing Jobs</a>
