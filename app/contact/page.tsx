export default function ContactPage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center py-20" style={{ border: '3px solid #18191a', borderRadius: 24, boxSizing: 'border-box', background: '#7b2c2c' }}>
