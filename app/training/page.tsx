...
export default function TrainingHubPage() {
  return (
    ...
    >
      ...
      <section style={{ width: '100%', maxWidth: 900, display: 'flex', flexDirection: 'column', gap: 32 }}>
        <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 2px 12px #ffd70022' }}>
          ...
          // ...existing code...
                ...
                <div style={{ flex: 1, background: '#fffbe7', borderRadius: 16, boxShadow: '0 2px 12px #ffd70022', padding: 24, minWidth: 260, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  <h2 style={{ color: '#ffd700', fontSize: '1.12rem', marginBottom: 18, fontWeight: 700, textAlign: 'center' }}>Programs Supporting AI Learning (Last 3 Years)</h2>
                  <div style={{ display: 'flex', alignItems: 'flex-end', gap: 18, height: 120, width: '100%', justifyContent: 'center', paddingBottom: 12 }}>
                    {aiProgramsData.map((item) => (
                      <div key={item.year} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: 60 }}>
                        <div style={{
                        ...
                        <span style={{ fontSize: '0.98rem', color: '#18191a', fontWeight: 700 }}>{item.year}</span>
                        <span style={{ fontSize: '0.92rem', color: '#6a1b9a', fontWeight: 500 }}>{item.count} programs</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <section style={{ width: '100%', maxWidth: 900, display: 'flex', flexDirection: 'column', gap: 32, marginTop: 24 }}>
                ...
                <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 2px 12px #ffd70022' }}>
                  <h2 style={{ color: '#ffd700', fontSize: '1.22rem', marginBottom: 12 }}>Learning Paths</h2>
                  {PATHS.map(p => (
                    <div key={p.name} style={{ marginBottom: 12 }}>
                      <strong style={{ color: '#ffd700' }}>{p.name}:</strong>
                      <ul style={{ color: '#18191a', marginLeft: 18, fontSize: '1.05rem', lineHeight: 1.7 }}>
                ...
                <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 2px 12px #ffd70022' }}>
                  <h2 style={{ color: '#ffd700', fontSize: '1.22rem', marginBottom: 12 }}>Project Ideas & Challenges</h2>
                  <ul style={{ color: '#18191a', fontSize: '1.05rem', lineHeight: 1.7 }}>
                    {PROJECTS.map((p, i) => <li key={i}>{p}</li>)}
                  </ul>
                </div>
                <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 2px 12px #ffd70022' }}>
                  <h2 style={{ color: '#ffd700', fontSize: '1.22rem', marginBottom: 12 }}>Popular AI Tools & Libraries</h2>
                  <ul style={{ color: '#18191a', fontSize: '1.05rem', lineHeight: 1.7 }}>
                    {TOOLS.map((t, i) => <li key={i}>{t}</li>)}
                  </ul>
                </div>
                <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 2px 12px #ffd70022' }}>
                  <h2 style={{ color: '#ffd700', fontSize: '1.22rem', marginBottom: 12 }}>Community & Mentorship</h2>
                  <ul style={{ color: '#18191a', fontSize: '1.05rem', lineHeight: 1.7 }}>
                ...
                <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 2px 12px #ffd70022' }}>
                  <h2 style={{ color: '#ffd700', fontSize: '1.22rem', marginBottom: 12 }}>Events & Workshops</h2>
                  <ul style={{ color: '#18191a', fontSize: '1.05rem', lineHeight: 1.7 }}>
